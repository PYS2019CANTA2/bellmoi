...
//import 'package:bellmoi/src/pages/camera/story_create_screen.dart';

import 'package:bellmoi/src/widgets/camera/camera_button.dart';
import 'package:bellmoi/src/widgets/camera/rounded_button.dart';
import 'package:bellmoi/src/widgets/camera/switch_icon.dart';
import 'package:bellmoi/src/widgets/camera/thumbnail_widget.dart';
...
class CameraScreenState extends State<CameraScreen> 
  ...
  Future getCameras() async {
    ...
    print('Camaras Disponibles : '+ cameras.length.toString());
  ...
  Future<String> takePicture({bool video = false}) async {
    ...
    final String dirPath = '${extDir.path}/Pictures/bellmoi';
    ...
    return Scaffold(
      ...
      body: Center(
        child: !isPermitted
            ...
            : Stack(
               children: <Widget>[_cameraPreviewWidget(),getOptionsWidget()],  // VERIFICAR
              ),
      ),
    );
  }
