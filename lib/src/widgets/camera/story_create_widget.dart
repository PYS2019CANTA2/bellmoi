...
import 'package:bellmoi/src/controllers/image_compresser.dart';
//import 'package:bellmoi/src/controllers/stories_controller.dart';
import 'package:bellmoi/src/models/camera/basic.dart';
import 'package:bellmoi/src/models/camera/text_data.dart';
import 'package:bellmoi/src/models/camera/image_data.dart';
import 'package:bellmoi/src/models/camera/smiley_data.dart';
  ...
  Future<bool> capturePNG() async {
    try {
      ...
      final Uint8List result = await ImageCompressor.compressImage(
          file);
      //await StoriesController.storeImage(result);  // VERIFICAR FUNCIONALIDAD
      return true;
    } catch (e) {
      print("False");
      print(e);
